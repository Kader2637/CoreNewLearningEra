                        ...
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                            ...
                            <li class="nav-item">
                                <button class="nav-link" id="discussion-tab" data-bs-toggle="tab"
                                    ...
                                    aria-controls="discussion-tab" aria-selected="false">Forum diskusi</button>
                            </li>
                        </ul>
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.status === "success") {
                        ...
                        const authorImage = dataKelas.user.profile ? `/storage/${dataKelas.user.profile}` :
                            '/user.png';
                        ...
                        if (daftarMateri.length > 0) {
                            daftarMateri.forEach(item => {
                                kontainerMateri.append(
                                    `<li><a href="/student/course/detail/${item.id}">${item.name}</a></li>`
                                );
                            });
                        } else {
                                        ...
                                        <div class="card-body">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="">
                                                    ...
                                                    <p class="mb-0 fs-14">${siswa.email}</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
