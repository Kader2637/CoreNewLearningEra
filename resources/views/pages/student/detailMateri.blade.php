        ...
        <form id="submit-task-form" action="/api/student/task/submit" method="POST" enctype="multipart/form-data">
            ...
            <div class="container mt-5">
                ...
                <div class="container mt-5">
                  ...
                  <div class="d-flex justify-content-between align-items-center m-3" style="border: 1px solid #ddd; padding: 10px;">
                    <div>
                        <h5>Tugas</h5>
                        <hr>
                    </div>
                    <span class="badge bg-success text-white p-2" ">Ditugaskan</span>
                </div>
