...
@section('content')
    ...
    <div class="d-flex justify-content-between">
        <div class="">
            <ul class="nav nav-tabs">
                ...
                <li class="nav-item"><a href="#discussion" data-bs-toggle="tab" class="nav-link">Diskusi Room</a>
                </li>
            </ul>
        </div>
        <div>
    ...
    <div class="tab-content">
        <div id="course" class="tab-pane fade active show">
            <div id="materialCards" class="mt-4 mb-5 row"></div>
        </div>
        <div id="student" class="tab-pane fade">
            <div class="mt-4 mb-5 row" id="student-list">
            </div>
        </div>
        <div id="approval" class="tab-pane fade">
            <div class="mt-4 mb-5 row" id="student-pending">
            </div>
        </div>
