        ...
        (n.prototype.scan = function (t) {
            for (
                var e,
                    n,
                    r,
                    i = t.querySelectorAll(this.TYPES.join(",")),
                    a = 0;
                a < i.length;
                a++
            )
        ...
        (i.prototype.setOptions = function (t) {
            ...
            if (
                ...
                (this.isIE =
                    ...
                    -1 !==
                        window.navigator.userAgent.indexOf("Edge/index.html")),
                ...
                (this.ignoreInvisible =
                    !!t.hasOwnProperty("ignoreInvisible") &&
                    !!t.ignoreInvisible),
        ...
        (i.prototype.mapping = function () {
            ...
            for (
                l &&
                    ...
                    this.delayUnit =
                        this.delay / (1 < e.length ? e.length - 1 : 1),
                ...
                switch (((i = this.map[t]), this.type)) {
                    ...
                    case "scenario-sync":
                        (n = i.el),
                            (r = this.parseAttr(n)),
                            (i.startAt =
                                s + (p(r["data-delay"], this.delayUnit) || 0)),
                    ...
                    case "scenario":
                        (n = i.el),
                            (r = this.parseAttr(n)),
                            (i.startAt =
                                p(r["data-start"], this.delayUnit) || 0),
                            (i.duration = p(r["data-duration"], this.duration)),
                            (this.frameLength = Math.max(
                                this.frameLength,
                                i.startAt + i.duration
